...
public class Panzer2PowerUp : PowerUp
{
    public Panzer2PowerUp(Ball ball, ContentManager content) : base(ball, content) {
        cooldown = 1f;
        powerUp_texture = content.Load<Texture2D> ("powerUp_textures/panzer2");
    }
